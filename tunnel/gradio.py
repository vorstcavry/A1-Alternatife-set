...
commandline_arguments = "--listen --enable-insecure-extension-access --theme dark --no-half-vae --disable-console-progressbars --share --disable-safe-unpickle --no-hashing --opt-sdp-attention --gradio" #@param{type:"string"}
#  ================= DETECT ENV =================
